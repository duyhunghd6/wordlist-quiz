...
export const GAMES = [
  ...
  { id: 'relativeDetective', emoji: '🕵️', name: 'Relative Detective', available: true, isGrammar: true },
  { id: 'inspectorTail', emoji: '🧲', name: 'Inspector Tail', available: true, isGrammar: true },
