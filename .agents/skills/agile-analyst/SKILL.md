...
**Step 1: Check Current Tasks (Beads CLI)**

- Run `bd ready --json` to see if there are unblocked research or ideation tasks.
- If the user provides a new topic, create a new epic/task first: Use `bd create "Market Research for X" -t feature -p 2 --json`
...
**Step 3: Close the Task (Beads CLI)**

- Once the document is created or the session is complete, close the task: `bd close <id> --reason "Document created" --json`
